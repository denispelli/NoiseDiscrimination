...
if true
   % Reversed psychometric function for crowding of target as a function of
   % flanker contrast.
   q=QuestCreate(tGuess,tGuessSd,pThreshold,beta,0,0); % Prob of detecting flanker.
   q.p2=delta*gamma+(1-delta)*(1-(1-gamma)*q.p2); % Prob of identifying target.
