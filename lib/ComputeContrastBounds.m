...
if o.printContrastBounds
    fprintf(['%d: LMin %.1f, LMax %.1f, LBackground %.1f, '...
        'nMin %.2f, nMax %.2f, '...
    ...
    fprintf('cMin %.2f spans [%.1f %.1f] cd/m^2, cMax %.2f spans [%.1f %.1f] cd/m^2\n',...
        cMin,(1+sort(cMin*[sMin sMax]))*o.LBackground,...
        cMax,(1+sort(cMax*[sMin sMax]))*o.LBackground);
    fprintf('o.contrast %.2f spans [%.1f %.1f] cd/m^2\n',...
        o.contrast,(1+sort(o.contrast*[sMin sMax]))*o.LBackground);
    fprintf('o.noiseSD %.2f spans [%.1f %.1f] cd/m^2, \n',...
        o.noiseSD,(1+[nMin nMax])*o.LBackground);
    fprintf('o.contrast %.2f plus o.noiseSD %.2f spans [%.1f %.1f] cd/m^2, \n',...
