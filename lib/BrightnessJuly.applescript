...
on run argv
	...
	tell application "System Events"
        ...
        tell process "System Preferences" to tell tab group 1 of window windowNumber
		set ok to false
		repeat with groupIndex in {2,1}
			try
				tell group groupIndex
					delay 1
					set oldLevel to value of value indicator 1 of slider 1 -- Get brightness
					delay 1
					if newLevel ≥ 0 and newLevel is not equal to oldLevel then
