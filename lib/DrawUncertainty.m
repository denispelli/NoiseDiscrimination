...
%     fprintf('x range %.0f to %.0f deg and %.0f to %.0f deg.\n',...
%         min(xyDeg(:,1)),max(xyDeg(:,1)),min(xy(:,1)),max(xy(:,1)));
%     fprintf('y range %.0f to %.0f deg and %.0f to %.0f deg.\n',...
%         min(xyDeg(:,2)),max(xyDeg(:,2)),min(xy(:,2)),max(xy(:,2)));
end
