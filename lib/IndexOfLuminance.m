...
if any(ii)
    msg0=sprintf('Contrast too high? Luminances %dx%dx%d (mean%csd %.1f%c%.1f), sd/mean %.1f, ranging %.1f to %.1f exceed linearized range %.1f to %.1f cd/m^2. ',...
    ...
    warning('IndexOfLuminance: %s%s%s',msg0,msg1,msg2,msg3);
