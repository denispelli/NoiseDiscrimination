function [n,terminatorChar] = GetEchoNumber(window,msg,x,y,textColor,bgColor,varargin)
% [n,terminatorChar] = GetEchoNumber(window, msg, x, y [, textColor][, bgColor][, deviceIndex][, untilTime=inf][, KbCheck args...])
%
...
% 7/25/17 dgp  Pass terminatorChar as second output argument.
if nargin < 6
    bgColor = [];
end
