clear all
load XiuyunFiltered 
[contrastFit,offset,scale,integrationRadius,SE] = fitNoiseIntegrationModel(XiuyunFiltered.mean_threshold,XiuyunFiltered.RadiusRelative2letter_size,XiuyunFiltered.noise_contrast);
...
legend('Power integration fit: radius of .7*letter size','Xiuyun data');
