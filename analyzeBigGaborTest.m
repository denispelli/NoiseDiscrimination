%% Analyze the data collected by runBigGaborTest.
% denis.pelli@nyu.edu
% February 20, 2020

experiment='BigGaborTest';
...
oo=ReadExperimentData({experiment 'runBigGaborTest'},vars); % Adds date and missingFields.
