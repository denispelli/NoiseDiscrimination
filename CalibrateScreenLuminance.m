...
try
    ...
    if automatic
        ...
        Speak('Please type name of your photometer. Just hit RETURN if it''s the minolta spotmeter.');
        msg=input('Please type name of photometer, \nor just <RETURN> for the Minolta Spotmeter:');
        if length(msg)<1
