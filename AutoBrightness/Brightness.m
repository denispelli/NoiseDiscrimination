...
%
% BRIGHTNESS. Get and set the "brightness" slider in the Mac OS X: System
...
% you try to call it while an onscreen window is already open.
%
% Brightness.m uses the Brightness.applescript to set the "brightness"
% slider in the Mac OS X: System Preferences: Displays panel. For use in
% MATLAB, please put both files anywhere in MATLAB's path. I hope they will
% be added to the Psychtoolbox.
%
% Written by denis.pelli@nyu.edu for the Psychtoolbox, June 25, 2017. On
% June 28, 2017, Fixed type of returned value, formerly a string, to now be
% a number.
%
% This Psychtoolbox MATLAB function calls my Brightness applescript. The
% applescript is equivalent to manually opening the System
% Preference:Displays panel and adjusting the "brightness" slider. I wrote
% the script to be invoked from MATLAB, but you could call it from any
% macOS application. Adjusting the "brightness" setting in an LCD, controls
% the luminance of the fluorescent light that is behind the liquid crystal
...
% that the brightness doesn't always change, or changes at another
...
if ~IsOSX
    ...
    % conceivable that Apple's brightness control is implemented on
    % Macintoshes running Linux or Windows, in which case someone might
    % enhance this program to work for those situations.
    oldLevel = NaN;
